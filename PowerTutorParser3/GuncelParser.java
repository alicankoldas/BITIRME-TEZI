...
public class parser_5 {
	public static void main(String[] args) 
    {
       ...
       //Name of the file
       String fileName="PowerTrace1461685395252_Snap.txt";
       try{
          ...
          List<Integer> liste_14 = new ArrayList<Integer>();
          List<Integer> liste_15 = new ArrayList<Integer>();
          ...
          while ((line = bufferReader.readLine()) != null)   { 
        	  		...
        	  		case "3G" :
        	  					...
        	  					{	  	
        	  						...
        	  						if (katar_3.equals("TOTAL") && array_9[2].equals(String.valueOf(processID)))
        	  						{
        			  					...
        			  					{
        			  	 		  			sayac_3G_total = sayac_3G_total + 1 ;	

        			  	 		  			if ( (sayac_begin-sayac_3G_total) > 0 )
        			  	 		  			{
        			  	 		  				while ( sayac_3G_total < sayac_begin)
        			  	 		  				{
        			  	 		  							sayac_3G_total = sayac_3G_total + 1 ;
        			  	 		  							liste_15.add(0);
        	  ...
        	  case "LC" :
      			  		...
      			  		if (katar_3.equals("TOTAL") && array_9[2].equals(String.valueOf(processID)))
      			  			{
      			  				...
      			  				if ( process_katar_2[2].equals(processID))
      			  					{
      			  	 		  			sayac_LCD_2 = sayac_LCD_2 + 1 ;	

      			  	 		  			if ( (sayac_begin-sayac_LCD_2) > 0 )
      			  	 		  				{
      			  	 		  					while ( sayac_LCD_2 < sayac_begin)
      			  	 		  						{
      			  	 		  							sayac_LCD_2 = sayac_LCD_2 + 1 ;
      			  	 		  							liste_14.add(0);
        		  ...
        		  if ( line.substring(0,4).equals("LCD "))
        		  	{	  	
  		  			sayac_LCD = sayac_LCD + 1 ;	

		  			 if ( (sayac_begin-sayac_LCD) > 0 )
		  			 {
		  				 while ( sayac_LCD < sayac_begin)
		  				 {
		  					 sayac_LCD = sayac_LCD + 1 ;
		  					 liste_6.add(0);
       ...
       PrintWriter pw = new PrintWriter(new File("SnapSnap.xls"));
       ...
       for (i=0;i<liste_1.size();i++)
       {
        ...
        sb.append(",");
      	...
      	sb.append(",");
     	sb.append(String.valueOf(liste_14.subList(i, i+1)).replaceAll("[\\[\\]]", ""));
      	sb.append(",");
      	sb.append(String.valueOf(liste_15.subList(i, i+1)).replaceAll("[\\[\\]]", ""));
      	sb.append(",");
      	sb.append("\n");
       }
