...
public class Login extends AppCompatActivity {
        ...
        submit_button.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean tarama = myDb.query(username_1.getText().toString(), password_1.getText().toString());
                        if ( tarama == true )
                        {
        ...
        account_button.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent("com.example.akoldas.mysixthapp.SignUp");
                        startActivity(intent);
                    }
                }
        );
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.akoldas.mysixthapp/http/host/path")
        );
